...
export default class extends React.Component {
   ...
   async handleFetchToken() {
      if (!this.state.token) {
         ...
         { method: 'POST', 
         headers: {
            Authorization:'Bearer 5-fup_4exL4.LTdnCILbAtQ5WfsbsOVF1IyVZknSqGu7lxuS4hDkM14'
       }});
         ...
         <div className="minimizable-web-chat">
            {minimized ? (
               <button className="maximize" onClick={this.handleMaximizeButtonClick}>
                  <span className={token ? 'fa fa-comment-dots' : 'fa fa-comment-dots'}/> 
                  <p>ITWorx Bot</p>
